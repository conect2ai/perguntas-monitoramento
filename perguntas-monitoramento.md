...
Este documento lista as perguntas de referência utilizadas para consultar a saúde, o consumo de recursos e o estado geral da infraestrutura (Máquinas Virtuais e Containers) nos ambientes de **Site** e **Testes**.
